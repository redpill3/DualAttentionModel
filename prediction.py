...
validationSet_predictions = ensemble_model.predict_generator(val_generator, steps = np.ceil(float(val_generator.samples)/float(batch_size)))

val_preds = np.argmax(validationSet_predictions, axis=-1)
...
numclassList = np.sum(cm, axis = 1)
print( '')

print(' akiec : ' + str(numclassList[0]))
print(' bcc : ' + str(numclassList[1]))
print(' bkl : ' + str(numclassList[2]))
print(' df : ' + str(numclassList[3]))
print(' mel : ' + str(numclassList[4]))
print(' nv : ' + str(numclassList[5]))
print(' vasc : ' + str(numclassList[6]))
